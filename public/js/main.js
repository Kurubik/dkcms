...
$(window).bind('resize', function () {
    ...
    $('[data-mobile-menu="close"]').click(function() {
        $('[data-mobile-menu="menu"]').addClass('hide');
    });
    $('[data-mobile-menu="hamburger"]').click(function() {
        $('[data-mobile-menu="menu"]').removeClass('hide');
    });
    $('[data-plan-filter-button]').click(function() {
        sendSelectFilters();
        $('[data-plan-filter-block-filter]').fadeOut('fast');
        $('[data-plan-filter-button-top-edit-block]').fadeIn('fast');
    });
    $('[data-plan-filter-button-top-edit]').click(function() {
        $('[data-plan-filter-block-filter]').fadeIn('fast');
        $('[data-plan-filter-button-top-edit-block]').fadeOut('fast');
    });
